var xPlanes = [
  ...
  {"Name":"X-31"
  ,"Description": "Thrust vectoring supermaneuverability",
  "ImgUrl":"http://www.check-six.com/images/Crash_Sites_images/X-31/X31-95Aerial.jpg"},
  {"Name":"X-37",
  "Description":"Reusable Space plane"
  ,"ImgUrl":"http://i.huffpost.com/gen/1495971/images/o-X37B-facebook.jpg"},
  {"Name":"X-45",
  "Description":" Unmanned combat vehicle",
...
for(var i=0; i<Object.keys(xPlanes).length; i++) {
  ...
  e.innerHTML += "<li>"+"<h2>"+xPlane.Name+"</h2>"+"<p>"+
  xPlane.Description +"</p>" +"<img src=\""+xPlane.ImgUrl+"\">"
  "</li>";
